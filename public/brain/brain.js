      ...
      //  console.log(story)
        try{
            ...
            console.log(networkSource)
                ...
                console.log("in the brain")
                console.log(currentStory.storyID)
                console.log(currentStory.notes)
                var corpus = "";
             ...
             //       console.log(notes[storyNotes[i]]);
                ...
                bm.addDocument({id: currentStory.storyID, body: corpus});
                console.log(bm)    
                         
//            corpus = BM25.Tokenize(corpus);
//            console.log(corpus)
//            var corpusWordCount = {};
//            for (var i = 0; i < corpus.length; i++){
//                if (corpusWordCount [corpus[i]] == null) corpusWordCount[corpus[i]] = 1;
//                else corpusWordCount[corpus[i]] += 1;
//            }
//            console.log(corpusWordCount)
//            console.log("***************************************")
        }
        catch(e){
            console.log(e)
...
BM25.prototype.search = function(query) {
	...
	for (var j = 0, nDocs = keys.length; j < nDocs; j++) {
		...
		for (var i = 0, len = queryTerms.length; i < len; i++) {
            ...
            var wordRelevance = idf * num / denom;
			this.documents[id]._score += wordRelevance;
            
            console.log("qt: "+ queryTerm + " - idf: " + idf + " - num: " + num + " - denom: " + denom + " - rel: " + wordRelevance)
		}
    ...
    console.log("RESULT buildzzzzzzzzzzzzzzzzzzzz")
    /******** temp ******/
